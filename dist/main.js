...
/* harmony import */ var _core_lo_response_interceptor__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./core/lo-response.interceptor */ 446);
...
AppModule = (0,tslib__WEBPACK_IMPORTED_MODULE_11__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_12__.NgModule)({
        ...
        providers: [
            ...
            { provide: _angular_common_http__WEBPACK_IMPORTED_MODULE_13__.HTTP_INTERCEPTORS, useClass: _core_lo_response_interceptor__WEBPACK_IMPORTED_MODULE_9__.LogResponseInterceptor, multi: true },
...
let CacheInterceptor = class CacheInterceptor {
    ...
    intercept(req, next) {
        ...
        const cacheResponse = this.casheService.get(req.url);
        // return cached response
        if (cacheResponse) {
            console.log(`Returning a cached response : ${cacheResponse.url}`);
            console.log(cacheResponse);
            return (0,rxjs__WEBPACK_IMPORTED_MODULE_2__.of)(cacheResponse);
        }
...
/***/ 446:
/*!*************************************************!*\
  !*** ./src/app/core/lo-response.interceptor.ts ***!
  \*************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
let EditBookComponent = class EditBookComponent {
    ...
    ngOnInit() {
        ...
        this.dataService.getOldBookById(bookID)
            .subscribe((data) => console.log(`Old Bok Title : ${data.bookTitle}`));
    }
    setMostPopular() {
